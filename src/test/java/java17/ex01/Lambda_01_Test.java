...
public class Lambda_01_Test {
    ...
    public void test_filter_by_age() throws Exception {
        ...
        PersonPredicate isAge = p -> {
        	
        	return p.getAge()>=18;
        	
        };
        
        List<Person> result = filter(personList, isAge);
    ...
    public void test_filter_by_firstname() throws Exception {
        ...
        PersonPredicate isFirst = p -> {
        	return p.getFirstname().equals("first_10");
        };
        
        List<Person> result = filter(personList, isFirst);
    ...
    public void test_filter_by_password() throws Exception {
        ...
        PersonPredicate isOk = p -> {
        	return p.getAge()>49 &&  String temp = DigestUtils.sha512Hex(p.getPassword()) == passwordSha512Hex ? true:false;
        };
        List<Person> result = filter(personList, isOk);
